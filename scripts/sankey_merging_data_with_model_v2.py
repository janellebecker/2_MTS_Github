...
df_fig_cov = pd.read_csv(data_dir + "/fig_cover_0517_made_170919.csv")
...
#Modify to have receipt type as receipt/deficit or outlay/surplus
    ...
    # Let's change the language to be more explicit for the sankey: Receipt/Deficit or Outlay/Surplus
